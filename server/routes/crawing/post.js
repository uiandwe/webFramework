...
post.getPageList = function (req, res, next){
...
post.getItemDetail = function (req, res, next) {
    var parseMyAwesomeHtml = function(html) {
...
post.saveCollectionPage = function(req, res, next){
...
post.saveCollectionItem = function(req, res, next){
